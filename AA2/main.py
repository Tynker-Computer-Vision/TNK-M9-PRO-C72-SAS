        ...
        for face in faces: 
            ...
            for choice in range(len(menuChoices)):  
                ...
                if menuChoices[choice] ==1:
                    ...
                    # Replace menuChoice with choice
                    filterImg = cv2.resize(menuImages[choice], (100, 100))
